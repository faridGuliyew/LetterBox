...
import com.example.letterboxf.databinding.FragmentFriendReviewsBinding
...
@AndroidEntryPoint
class FriendReviewsFragment : BaseFragment<FragmentFriendReviewsBinding>(FragmentFriendReviewsBinding::inflate) {
    ...
    override fun onViewCreatedLight() {
        ...
        observe()
        reviewViewModel.getFriendsReview(getMovieId())
        setRv()
    }
